...
message3 = tk.Label(window, text="AI Based Attendance System Using Face Recognition" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
def send_email():
    ...
    from_email = "anirbang752@gmail.com"  # Update with your email
    password = "guol rsyu zdtw sjzu"  # Update with your email password
